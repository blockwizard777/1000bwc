...
const MainMenu = () => {
    ...
    const [lobbyCode, setLobbyCode] = (0, react_1.useState)("");
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: styles.container, children: [(0, jsx_runtime_1.jsx)("h1", { style: styles.title, children: "1000 Blank White Cards" }), (0, jsx_runtime_1.jsx)("h2", { style: styles.subtitle, children: "sub 2 CowboyNumber4 on YT" }), (0, jsx_runtime_1.jsx)("input", { type: "text", placeholder: "Enter Username", value: username, onChange: (e) => setUsername(e.target.value), style: styles.input }), (0, jsx_runtime_1.jsx)("input", { type: "text", placeholder: "Enter Lobby Code", value: lobbyCode, onChange: (e) => setLobbyCode(e.target.value), style: styles.input }), (0, jsx_runtime_1.jsxs)("div", { style: styles.buttonContainer, children: [(0, jsx_runtime_1.jsx)("button", { style: styles.button, onMouseEnter: (e) => (e.currentTarget.style.backgroundColor = styles.buttonHover.backgroundColor || ''), onMouseLeave: (e) => (e.currentTarget.style.backgroundColor = styles.button.backgroundColor || ''), onClick: handleJoin, children: "Join Game" }), (0, jsx_runtime_1.jsx)("button", { style: styles.button, onMouseEnter: (e) => (e.currentTarget.style.backgroundColor = styles.buttonHover.backgroundColor || ''), onMouseLeave: (e) => (e.currentTarget.style.backgroundColor = styles.button.backgroundColor || ''), onClick: handleHost, children: "Host Game" }), (0, jsx_runtime_1.jsx)("button", { style: styles.button, onMouseEnter: (e) => (e.currentTarget.style.backgroundColor = styles.buttonHover.backgroundColor || ''), onMouseLeave: (e) => (e.currentTarget.style.backgroundColor = styles.button.backgroundColor || ''), onClick: handleEditCards, children: "Edit Cards" })] })] }));
};
const styles = {
    container: {
        display: "flex",
